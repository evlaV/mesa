...
static ALWAYS_INLINE void
radv_write_buffer_descriptor_impl(struct radv_device *device, struct radv_cmd_buffer *cmd_buffer,
                                  VkDescriptorType descriptor_type, unsigned *dst,
                                       ...
                                       bool use_combined_image_sampler)
{
   ...
   radv_write_image_descriptor_ycbcr(device, dst, image_info, use_combined_image_sampler);
